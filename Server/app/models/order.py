...
class Order(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.now)  # usa función, no resultado
    estimated_delivery_date = db.Column(db.DateTime, nullable=False)
    real_delivery_date = db.Column(db.DateTime)  # mejor permitir nulo si aún no se entrega
