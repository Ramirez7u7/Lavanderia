...
from app.controllers.order_controller import create_order, add_garment_to_order, create_order_detail, add_service, get_order_detail, get_counting ,get_orders_dashboard,get_pending_orders_dashboard
import datetime
...
@order_bp.route("/get-orders-dashboard/<int:order_id>", methods=["GET"])
def get_orders_dashboard_endpoint():
    ...
    try:
       ...
       return jsonify(data), 200
        ...
        print("error al obtener las ordenes del dashboard")
        return jsonify({
            "msg": "ocurrui un error imprevisto"
        })
    
@order_bp.route("/get-pending-orders-dashboard/<int:order_id>", methods=["GET"])
